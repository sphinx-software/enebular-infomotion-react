...
var Livebutton = function (_React$Component) {
    ...
    _createClass(Livebutton, [{
        ...
        value: function componentDidMount() {
            var liveButton = _enebularInfomotion.infomotionUI.liveButton(this.liveBtn).make();
            liveButton.setDateRange(new _enebularInfomotion.infomotion.DateRange(this.props.dateRange[0], this.props.dateRange[1]));
