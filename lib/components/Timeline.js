...
var Timeline = function (_React$Component) {
    ...
    _createClass(Timeline, [{
        ...
        value: function componentDidMount() {
            var timeline = _enebularInfomotion.infomotionUI.timeline(this.timelineElement, this.minDateElement, this.maxDateElement, this.btnControl).withRange(this.props.dateRange).make();
