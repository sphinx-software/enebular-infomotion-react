...
var Timeline = function (_React$Component) {
    ...
    _createClass(Timeline, [{
        ...
        value: function componentDidMount() {
            var timeline = _enebularInfomotionV.infomotionUI.timeline(this.timelineElement, this.btnControl).setTheme(this.props.theme).make();
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { ref: function ref(element) {
                        ...
                        }, className: this.props.classNamePlay },
                    _react2.default.createElement('i', { className: 'fa fa-play' })
                ),
                _react2.default.createElement('div', { style: styles.timeline, ref: function ref(element) {
