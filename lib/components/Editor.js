    ...
    _createClass(Editor, [{
        ...
        value: function onEditorClick() {
            ...
            this.setState({ modalEditor: true }, function () {
                var graphEditor = _enebularInfomotionV.infomotionUI.graphEditor(_this2.formEditorElement).withDatasources(_this2.props.datasources).withPluginManager(_this2.props.pluginManager).withSettings(_this2.props.graphEditor).setPrimaryClass(_this2.props.classNamePrimary).hasCancelButton(_this2.props.hasCancelBtn);
                if (_this2.props.useAddMode) {
                ...
                graphEditor.onChange(function (config) {
                    ...
                    _this2.setState({ modalEditor: false });
                });
                ...
                _this2.props.onReady(graphEditor);
            });
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.autoOpen ? '' : _react2.default.createElement(
                    'button',
...
Editor.propTypes = {
    ...
    classNamePrimary: _propTypes2.default.string,
    hasCancelBtn: _propTypes2.default.bool,
    useAddMode: _propTypes2.default.bool,
