    ...
    _createClass(Editor, [{
        ...
        value: function onEditorClick() {
            ...
            this.setState({ modalEditor: true }, function () {
                var graphEditor = _enebularInfomotionV.infomotionUI.graphEditor(_this2.formEditorElement).withDatasources(_this2.props.datasources).withPluginManager(_this2.props.pluginManager).withSettings(_this2.props.graphEditor).hasCancelButton(_this2.props.hasCancelBtn);
