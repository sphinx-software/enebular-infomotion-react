      ...
      return _react2.default.createElement(
        ...
        this.props.list.map(function (item, index) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement('i', { className: 'fa fa-pencil', onClick: _this2.onFilterEdit.bind(_this2, index), style: { marginRight: '10px', cursor: 'pointer' } }),
            _react2.default.createElement('i', { className: 'fa fa-close red', onClick: _this2.onFilterRemove.bind(_this2, index), style: { cursor: 'pointer' } })
          );
        })
      );
    }
