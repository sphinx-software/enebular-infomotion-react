    ...
    _createClass(Filter, [{
        ...
        value: function onFilterClick() {
            ...
            this.setState({ modalFilter: true }, function () {
                var filterUI = _enebularInfomotionV.infomotionUI.filter(_this2.formFilterElement).setOptions(_this2.props.filterUI.options).setFilters(_this2.props.filterUI.filter).setPrimaryClass(_this2.props.classNamePrimary).setInfoClass(_this2.props.classNameInfo).make();

                filterUI.open();

                _this2.props.onReady(filterUI);
...
Filter.propTypes = {
    ...
    classNameInfo: _propTypes2.default.string,
