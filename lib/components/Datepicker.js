...
var DatePicker = function (_React$Component) {
    ...
    _createClass(DatePicker, [{
        ...
        value: function componentDidMount() {
            ...
            var datePicker = _enebularInfomotion.infomotionUI.datePicker(this.datePicker).withRange(this.props.dateRange).make();
        ...
        value: function render() {
            ...
            return _react2.default.createElement('input', { style: { width: '100%' }, ref: function ref(input) {
