...
class DatePicker extends React.Component {
    ...
    componentDidMount() {
        let datePicker = infomotionUI.datePicker(this.datePicker).withRange(this.props.dateRange).make();
    ...
    render() {
        return React.createElement('input', { className: 'dashboard-datepicker', style: { width: '100%' }, ref: input => {
